...
export type PlatformPublic = S["PlatformPublic"];
export type FaqPublic = S["FaqPublic"];
export type PagePublic = S["PagePublic"];
export type PageSummary = S["PagePublicSummary"];

export type SiteSettingsPublic = S["SiteSettingsPublic"];
